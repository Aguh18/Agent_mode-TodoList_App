...
public class AIOrchestatorController {
    ...
    public ResponseEntity<?> processChat(@RequestBody Map<String, Object> request, HttpServletRequest httpRequest) {
        try {
            ...
            Map<String, Object> response = aiOrchestatorService.processUserMessageByUserId(userMessage, userId, language, autoExecute);
            ...
            if (Boolean.TRUE.equals(shouldAutoExecute) && response.containsKey("actions")) {
                ...
                if (Boolean.TRUE.equals(actions.get("actionable"))) {
                    ...
                    try {
                        ...
                        Object actionResult = aiOrchestatorService.executeActionByUserId(suggestedAction, actionParams, userId);
                        ...
                        List<TodoEntity> updatedTodos = todoService.getMyTodosByUserId(userId);
